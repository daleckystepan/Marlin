...
#define STRING_CONFIG_H_AUTHOR "Stepan Dalecky" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 20.01
  #define DEFAULT_bedKd 337.49
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.14, 80.28, 400, 440 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31, 6, -1.00 }
...
#define X_MIN_POS (-13-5) // -13mm from bed edge, additional -5mm from bed edge
#define Y_MIN_POS (-3-5)  //  -3mm from bed edge, additional -5mm from bed edge
#define Z_MIN_POS 0
