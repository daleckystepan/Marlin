...
//#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_ABORT "G0 X0 Y225 F5000"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
 ...
 */
  ...
  #define HOLD_MULTIPLIER    0.40 // Scales down the holding current from run current
