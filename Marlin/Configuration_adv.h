 ...
 */
  ...
  #define PID_EXTRUSION_SCALING
    ...
    #define DEFAULT_Kc (125) // heating power = Kc * e_speed
  ...
  #define PID_FAN_SCALING
    ...
    #define PID_FAN_SCALING_ALTERNATIVE_DEFINITION
      ...
      #define DEFAULT_Kf 17.0                            // A constant value added to the PID-tuner
 ...
 */
  ...
  #define FAST_PWM_FAN_FREQUENCY 50
...
#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 0.05, 0.05, 0.05 } // (mm)
  #define BACKLASH_CORRECTION    0.50       // 0.0 = no correction; 1.0 = full correction
...
#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define EVENT_GCODE_SD_ABORT "G91\nG0 Z10 F600\nG90\nG0 X0 Y225 F6000"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
